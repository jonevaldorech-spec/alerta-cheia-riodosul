# Cheia — Rio do Sul (SC) — 2026-09-15 10:00 (local −03)
...
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.008 m/h (anterior -0.002 m/h) · chuva-driver 2h 0.1 mm/h
...
- baseline = VALE do ato: 5.04 m em 15/09 09:59 (DC-RS) · subida até agora 0.0 m
...
|---|---|---|---|---|---|---|
| Oeste | 57.48 → 57.18 | 0.0 | 1.00 | 7A/0F | 18.23 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 57.18 | 7A/0F | 0 | 18.23 m | 15/09 09:52 |
| Barragem Sul Ituporanga | 7.72 | 5A/0F | 0 | 15.5 m | 15/09 09:52 |
...
- nível atual: SDC 5.2 m · DC-RS 5.04 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.15 m
