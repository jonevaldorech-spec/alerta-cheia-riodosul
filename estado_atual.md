# Cheia — Rio do Sul (SC) — 2026-09-08 12:30 (local −03)
...
|---|---|---|---|---|---|---|
| Oeste | 10.69 → 4.2 | 0.0 | 1.00 | 7A/0F | 8.84 m |  |
...
|---|---|---|---|---|
| Barragem Oeste Taió | 4.2 | 7A/0F | 0 | 8.84 m |
...
- nível atual: SDC 4.78 m · DC-RS 4.63 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.13 m
