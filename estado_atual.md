# Cheia — Rio do Sul (SC) — 2026-09-12 01:00 (local −03)
...
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.006 m/h (anterior 0.046 m/h) · chuva-driver 2h 0.0 mm/h
...
- cj efetiva 69 mm = cj 50 + trânsito-acima 0 (fração de comportas aberta 0.00) + pluviômetro-ΔV 19 (ΔV do ato 27.0 hm³)
...
|---|---|---|---|---|---|---|
| Oeste | 14.87 → 34.45 | 19.6 | 0.00 | 0A/7F | 15.07 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 34.45 | 0A/7F | 0 | 15.07 m | 12/09 00:56 |
| Barragem Sul Ituporanga | 7.72 | 0A/5F | 0 | 15.5 m | 12/09 00:56 |
...
- nível atual: SDC 6.04 m · DC-RS 5.87 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.32 m
