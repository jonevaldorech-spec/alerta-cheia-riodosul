# Cheia — Rio do Sul (SC) — 2026-09-12 17:00 (local −03)
...
**Chuva 24h máx (drivers):** 13.9 mm
**EVENTO ATIVO:** 🔴 SIM

**🎯 MODO CRISTA (nowcast — chuva encerrada, réguas-líder viradas):** pico ~5.51 m → **ALERTA** · crista já atingida/passando
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.025 m/h (anterior -0.023 m/h) · chuva-driver 2h 0.1 mm/h
...
- baseline = VALE do ato: 5.5 m em 12/09 16:44 (DC-RS) · subida até agora 0.0 m
...
|---|---|---|---|---|---|---|
| Oeste | 54.23 → 54.68 | 0.4 | 0.00 | 0A/7F | 17.9 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 54.68 | 0A/7F | 0 | 17.9 m | 12/09 16:56 |
| Barragem Sul Ituporanga | 21.37 | 2A/3F | 0 | 19.7 m | 12/09 16:56 |
...
- nível atual: SDC 5.66 m · DC-RS 5.5 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 4.22 m
