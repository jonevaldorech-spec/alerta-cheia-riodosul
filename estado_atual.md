# Cheia — Rio do Sul (SC) — 2026-09-16 06:30 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 4.67 m — **ATENÇÃO** · tendência estável/caindo
- SDC-00013: 4.83 m · DC-RS Dom Tito: 4.67 m · offset medido DC-RS−SDC: -0.16 m
**Chuva 24h máx (drivers):** 0.5 mm
**EVENTO ATIVO:** 🔴 SIM

**🎯 MODO CRISTA (nowcast — chuva encerrada, réguas-líder viradas):** pico ~4.67 m → **ATENÇÃO** · crista já atingida/passando
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.069 m/h (anterior -0.054 m/h) · chuva-driver 2h 0.1 mm/h
...
- baseline = VALE do ato: 4.67 m em 16/09 06:22 (DC-RS) · subida até agora 0.0 m
...
- sombra (cj_lat, c/ laterais): ~4.7 m (cj 0 mm · Δcj_lat−cj_v07 = 0.0 mm, n_laterais=4)
...
|---|---|---|---|---|---|---|
| Oeste | 48.56 → 48.41 | 0.0 | 1.00 | 7A/0F | 17.06 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 48.41 | 7A/0F | 0 | 17.06 m | 16/09 06:22 |
| Barragem Sul Ituporanga | 1.01 | 5A/0F | 0 | 10.3 m | 16/09 06:22 |
...
- **A) SDC-00013:** baseline 4.83 m · pico v1.0 ~4.8 m (banda 4.3–5.3) → **Atenção**
- **B) DC-RS Dom Tito:** baseline 4.67 m · pico v1.0 ~4.7 m (banda 4.2–5.2) → **Atenção**
- **Δ pico (B − A): -0.10 m** · classe inalterada
- nível atual: SDC 4.83 m · DC-RS 4.67 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 3.74 m
