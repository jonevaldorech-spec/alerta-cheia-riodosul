# Cheia — Rio do Sul (SC) — 2026-09-13 08:00 (local −03)
...
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.013 m/h (anterior -0.01 m/h) · chuva-driver 2h 0.2 mm/h
...
- chuva-jusante do ato: 0.5 mm (drivers (divergiu +18% das ancoras); soma horária desde o vale (14 h, cobertura 100%)) · chuva-acima 1.7 mm
- cj efetiva 6 mm = cj 0 + trânsito-acima 0 (fração de comportas aberta 0.20) + pluviômetro-ΔV 5 (ΔV do ato 7.1 hm³)
...
|---|---|---|---|---|---|---|
| Oeste | 55.44 → 62.55 | 7.1 | 0.00 | 0A/7F | 18.92 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 62.55 | 0A/7F | 0 | 18.92 m | 13/09 07:56 |
| Barragem Sul Ituporanga | 21.04 | 2A/3F | 0 | 19.61 m | 13/09 07:56 |
...
- nível atual: SDC 5.79 m · DC-RS 5.61 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 4.77 m
