# Cheia — Rio do Sul (SC) — 2026-09-13 03:00 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 5.66 m — **ALERTA** · tendência subindo
...
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual 0.003 m/h (anterior 0.017 m/h) · chuva-driver 2h 0.6 mm/h
...
- chuva-jusante do ato: 0.4 mm (ancoras; soma horária desde o vale (10 h, cobertura 100%)) · chuva-acima 0.9 mm
- cj efetiva 4 mm = cj 0 + trânsito-acima 0 (fração de comportas aberta 0.20) + pluviômetro-ΔV 4 (ΔV do ato 5.0 hm³)
...
|---|---|---|---|---|---|---|
| Oeste | 55.44 → 60.48 | 5.0 | 0.00 | 0A/7F | 18.66 m |  |
...
_Chuva-acima (contexto de barragem, fora do cj):_ Taio_montante 2.4, Rio do Campo 0.2, Alfredo Wagner 0.0

## Barragens (Asthon)

| Barragem | % uso | Comportas | Vertido | Montante | Medida em |
|---|---|---|---|---|---|
| Barragem Oeste Taió | 60.48 | 0A/7F | 0 | 18.66 m | 13/09 02:56 |
| Barragem Sul Ituporanga | 21.21 | 2A/3F | 0 | 19.67 m | 13/09 02:56 |
