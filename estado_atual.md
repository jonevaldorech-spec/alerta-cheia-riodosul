# Cheia — Rio do Sul (SC) — 2026-09-05 17:00 (local −03)
...
|---|---|---|---|---|---|---|
| Oeste | 30.76% (curva 31.6%) | 15.01→14.53 | -0.06 | 0.0 | 0.0 | ⚠ 0 — não está enchendo (taxa ≤ 0) — sem crédito |
| Sul | 33.86% (curva 34.8%) | 23.14→22.42 | -0.09 | 0.0 | 0.0 | ⚠ 0 — não está enchendo (taxa ≤ 0) — sem crédito |
...
|---|---|---|---|---|
| Barragem Oeste Taió | 30.76 | 7A/0F | 0 | 14.5 m |
