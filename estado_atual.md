# Cheia — Rio do Sul (SC) — 2026-09-12 06:30 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 5.76 m — **ALERTA** · tendência estável/caindo
- SDC-00013: 5.93 m · DC-RS Dom Tito: 5.76 m · offset medido DC-RS−SDC: -0.17 m
**Chuva 24h máx (drivers):** 80.6 mm
**EVENTO ATIVO:** 🔴 SIM

**🎯 MODO CRISTA (nowcast — chuva encerrada, réguas-líder viradas):** pico ~5.76 m → **ALERTA** · crista já atingida/passando
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.02 m/h (anterior -0.024 m/h) · chuva-driver 2h 0.0 mm/h
...
- baseline = VALE do ato: 3.83 m em 11/09 06:42 (DC-RS) · subida até agora 1.93 m
- chuva-jusante do ato: 49.8 mm (ancoras; soma horária desde o vale (24 h, cobertura 100%)) · chuva-acima 60.8 mm
- cj efetiva 83 mm = cj 50 + trânsito-acima 0 (fração de comportas aberta 0.00) + pluviômetro-ΔV 33 (ΔV do ato 46.7 hm³)
...
|---|---|---|---|---|---|---|
| Oeste | 14.87 → 43.0 | 28.1 | 0.00 | 0A/7F | 16.31 m |  |
| Sul | 0.58 → 18.49 | 18.6 | 0.00 | 0A/5F | 19.01 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 43.0 | 0A/7F | 0 | 16.31 m | 12/09 06:26 |
| Barragem Sul Ituporanga | 18.49 | 0A/5F | 0 | 19.01 m | 12/09 06:26 |
...
- nível atual: SDC 5.93 m · DC-RS 5.76 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 4.77 m
