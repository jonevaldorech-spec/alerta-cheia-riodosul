# Cheia — Rio do Sul (SC) — 2026-09-11 22:00 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 5.85 m — **ALERTA** · tendência subindo
- SDC-00013: 6.01 m · DC-RS Dom Tito: 5.85 m · offset medido DC-RS−SDC: -0.16 m
**Chuva 24h máx (drivers):** 82.8 mm
**EVENTO ATIVO:** 🔴 SIM

**🎯 MODO CRISTA (nowcast — chuva encerrada, réguas-líder viradas):** pico ~5.85 m → **ALERTA** · crista em ~1 h
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual 0.076 m/h (anterior 0.159 m/h) · chuva-driver 2h 1.5 mm/h
...
- baseline = VALE do ato: 3.83 m em 11/09 06:42 (DC-RS) · subida até agora 2.02 m
- chuva-jusante do ato: 49.8 mm (ancoras; soma horária desde o vale (16 h, cobertura 100%)) · chuva-acima 60.9 mm
- cj efetiva 66 mm = cj 50 + trânsito-acima 0 (fração de comportas aberta 0.00) + pluviômetro-ΔV 16 (ΔV do ato 22.4 hm³)
- sombra (cj_lat, c/ laterais): ~5.5 m (cj 41 mm · Δcj_lat−cj_v07 = -5.8 mm, n_laterais=4)
...
|---|---|---|---|---|---|---|
| Oeste | 14.87 → 29.91 | 15.0 | 0.00 | 0A/7F | 14.37 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 29.91 | 0A/7F | 0 | 14.37 m | 11/09 21:56 |
| Barragem Sul Ituporanga | 7.72 | 0A/5F | 0 | 15.5 m | 11/09 21:56 |
...
- nível atual: SDC 6.01 m · DC-RS 5.85 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.64 m
