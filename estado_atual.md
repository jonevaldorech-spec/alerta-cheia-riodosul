# Cheia — Rio do Sul (SC) — 2026-09-10 13:00 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 4.15 m — **Normal** · tendência subindo
- SDC-00013: 4.3 m · DC-RS Dom Tito: 4.15 m · offset medido DC-RS−SDC: -0.15 m
**Chuva 24h máx (drivers):** 83.4 mm
**EVENTO ATIVO:** 🔴 SIM

**🎯 MODO CRISTA (nowcast — chuva encerrada, réguas-líder viradas):** pico ~4.15 m → **Normal** · crista em ~1 h
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual 0.075 m/h (anterior 0.112 m/h) · chuva-driver 2h 0.0 mm/h
...
- baseline = VALE do ato: 2.93 m em 09/09 23:09 (DC-RS) · subida até agora 1.22 m
...
|---|---|---|---|---|---|---|
| Sul | 0.0 → 0.0 | 0.0 | 1.00 | 0A/5F | 7.0 m |  |
...
_Chuva-acima (contexto de barragem, fora do cj):_ Taio_montante 47.6, Rio do Campo 39.2, Alfredo Wagner 23.9
...
- nível atual: SDC 4.3 m · DC-RS 4.15 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 4.3 m
