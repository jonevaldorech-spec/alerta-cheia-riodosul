# Cheia — Rio do Sul (SC) — 2026-09-05 18:00 (local −03)
...
|---|---|---|---|---|---|---|
| Oeste | 30.37% (curva 31.3%) | 14.96→14.48 | -0.06 | 0.0 | 0.0 | ⚠ 0 — não está enchendo (taxa ≤ 0) — sem crédito |
| Sul | 33.86% (curva 34.2%) | 22.94→22.3 | -0.08 | 0.0 | 0.0 | ⚠ 0 — não está enchendo (taxa ≤ 0) — sem crédito |
- termo de barragem (fino): Oeste reteve 0.0 hm³ na janela (~0 m³/s; ocup.~30%) | Sul reteve 0.0 hm³ na janela (~0 m³/s; ocup.~34%)
...
_Chuva-acima (contexto de barragem, fora do cj):_ Taio_montante 15.6, Rio do Campo 11.6, Alfredo Wagner 0.1

## Barragens (Asthon)

| Barragem | % uso | Comportas | Vertido | Montante |
|---|---|---|---|---|
| Barragem Oeste Taió | 30.37 | 7A/0F | 0 | 14.44 m |
| Barragem Sul Ituporanga | 33.86 | 5A/0F | 0 | 22.3 m |
