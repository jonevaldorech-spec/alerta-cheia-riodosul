# Cheia — Rio do Sul (SC) — 2026-09-15 03:30 (local −03)
...
- chuva-jusante do ato: 0.0 mm (drivers (divergiu -66% das ancoras); soma horária desde o vale (10 h, cobertura 100%)) · chuva-acima 0.4 mm
...
|---|---|---|---|---|---|---|
| Oeste | 63.99 → 60.01 | 0.0 | 0.98 | 7A/0F | 18.6 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 60.01 | 7A/0F | 0 | 18.6 m | 15/09 03:22 |
| Barragem Sul Ituporanga | 15.52 | 5A/0F | 0 | 18.2 m | 15/09 03:22 |
...
- nível atual: SDC 5.23 m · DC-RS 5.07 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.27 m
