# Cheia — Rio do Sul (SC) — 2026-09-15 20:00 (local −03)
...
- baseline = VALE do ato: 5.0 m em 15/09 19:31 (DC-RS) · subida até agora 0.01 m
...
|---|---|---|---|---|---|---|
| Oeste | 53.01 → 52.71 | 0.0 | 1.00 | 7A/0F | 17.64 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 52.71 | 7A/0F | 0 | 17.64 m | 15/09 19:52 |
| Barragem Sul Ituporanga | 1.01 | 5A/0F | 0 | 10.3 m | 15/09 19:52 |
...
- **A) SDC-00013:** baseline 5.16 m · pico v1.0 ~5.2 m (banda 4.7–5.7) → **Atenção**
- **B) DC-RS Dom Tito:** baseline 5.0 m · pico v1.0 ~5.0 m (banda 4.5–5.5) → **Atenção**
- **Δ pico (B − A): -0.20 m** · classe inalterada
- nível atual: SDC 5.16 m · DC-RS 5.01 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 4.89 m
