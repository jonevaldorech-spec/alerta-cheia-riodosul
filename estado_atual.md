# Cheia — Rio do Sul (SC) — 2026-09-08 12:00 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 4.62 m — **ATENÇÃO** · tendência estável/caindo
- SDC-00013: 4.78 m · DC-RS Dom Tito: 4.62 m · offset medido DC-RS−SDC: -0.16 m
...
- baseline = VALE do ato: 3.45 m em 07/09 23:07 (DC-RS) · subida até agora 1.17 m
- chuva-jusante do ato: 0.0 mm (drivers (divergiu -73% das ancoras); soma horária desde o vale (14 h, cobertura 100%)) · chuva-acima 0.0 mm
...
|---|---|---|---|---|---|---|
| Oeste | 10.69 → 4.42 | 0.0 | 1.00 | 7A/0F | 8.94 m |  |
...
|---|---|---|---|---|
| Barragem Oeste Taió | 4.42 | 7A/0F | 0 | 8.94 m |
...
- nível atual: SDC 4.78 m · DC-RS 4.62 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.15 m
