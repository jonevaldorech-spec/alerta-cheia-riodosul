# Cheia — Rio do Sul (SC) — 2026-09-08 16:30 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 4.57 m — **ATENÇÃO** · tendência estável/caindo
- SDC-00013: 4.72 m · DC-RS Dom Tito: 4.57 m · offset medido DC-RS−SDC: -0.15 m
**Chuva 24h máx (drivers):** 0.2 mm
**EVENTO ATIVO:** 🔴 SIM

**🎯 MODO CRISTA (nowcast — chuva encerrada, réguas-líder viradas):** pico ~4.57 m → **ATENÇÃO** · crista já atingida/passando
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.013 m/h (anterior -0.015 m/h) · chuva-driver 2h 0.0 mm/h
...
- baseline = VALE do ato: 3.45 m em 07/09 23:07 (DC-RS) · subida até agora 1.12 m
- chuva-jusante do ato: 0.0 mm (drivers (divergiu -73% das ancoras); soma horária desde o vale (18 h, cobertura 100%)) · chuva-acima 0.0 mm
...
|---|---|---|---|---|---|---|
| Oeste | 10.69 → 2.55 | 0.0 | 1.00 | 7A/0F | 7.85 m |  |
| Sul | 16.6 → 11.63 | 0.0 | 1.00 | 5A/0F | 17.0 m |  |
...
|---|---|---|---|---|
| Barragem Oeste Taió | 2.55 | 7A/0F | 0 | 7.85 m |
| Barragem Sul Ituporanga | 11.63 | 5A/0F | 0 | 17.0 m |
...
- nível atual: SDC 4.72 m · DC-RS 4.57 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 4.99 m
