# Cheia — Rio do Sul (SC) — 2026-09-10 04:30 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 3.27 m — **Normal** · tendência subindo
- SDC-00013: 3.4 m · DC-RS Dom Tito: 3.27 m · offset medido DC-RS−SDC: -0.13 m
...
- baseline = VALE do ato: 2.93 m em 09/09 23:09 (DC-RS) · subida até agora 0.34 m
- chuva-jusante do ato: 38.7 mm (drivers (divergiu -19% das ancoras); soma horária desde o vale (6 h, cobertura 100%)) · chuva-acima 36.3 mm
...
_Chuva-acima (contexto de barragem, fora do cj):_ Taio_montante 47.2, Rio do Campo 37.8, Alfredo Wagner 23.9

## Barragens (Asthon)

| Barragem | % uso | Comportas | Vertido | Montante |
|---|---|---|---|---|
| Barragem Sul Ituporanga | 0.0 | 5A/0F | 0 | 3.0 m |
...
- nível atual: SDC 3.4 m · DC-RS 3.27 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 2.86 m
