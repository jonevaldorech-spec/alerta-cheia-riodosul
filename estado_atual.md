# Cheia — Rio do Sul (SC) — 2026-09-15 08:30 (local −03)
...
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.006 m/h (anterior 0.0 m/h) · chuva-driver 2h 0.1 mm/h
...
- baseline = VALE do ato: 5.05 m em 15/09 08:28 (DC-RS) · subida até agora 0.0 m
...
|---|---|---|---|---|---|---|
| Oeste | 58.02 → 57.79 | 0.0 | 1.00 | 7A/0F | 18.31 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 57.79 | 7A/0F | 0 | 18.31 m | 15/09 08:22 |
| Barragem Sul Ituporanga | 7.72 | 5A/0F | 0 | 15.5 m | 15/09 08:22 |
...
- **A) SDC-00013:** baseline 5.21 m · pico v1.0 ~5.2 m (banda 4.7–5.7) → **Atenção**
- **B) DC-RS Dom Tito:** baseline 5.05 m · pico v1.0 ~5.1 m (banda 4.6–5.6) → **Atenção**
- **Δ pico (B − A): -0.10 m** · classe inalterada
- nível atual: SDC 5.22 m · DC-RS 5.05 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.18 m
