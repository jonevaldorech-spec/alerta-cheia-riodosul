# Cheia — Rio do Sul (SC) — 2026-09-12 00:30 (local −03)
...
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual 0.009 m/h (anterior 0.06 m/h) · chuva-driver 2h 0.0 mm/h
...
- cj efetiva 68 mm = cj 50 + trânsito-acima 0 (fração de comportas aberta 0.00) + pluviômetro-ΔV 19 (ΔV do ato 26.2 hm³)
...
|---|---|---|---|---|---|---|
| Oeste | 14.87 → 33.67 | 18.8 | 0.00 | 0A/7F | 14.95 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 33.67 | 0A/7F | 0 | 14.95 m | 12/09 00:26 |
| Barragem Sul Ituporanga | 7.72 | 0A/5F | 0 | 15.5 m | 12/09 00:26 |
...
- nível atual: SDC 6.05 m · DC-RS 5.89 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.37 m
