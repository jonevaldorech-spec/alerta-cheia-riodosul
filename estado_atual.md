# Cheia — Rio do Sul (SC) — 2026-09-14 10:30 (local −03)
...
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.029 m/h (anterior -0.026 m/h) · chuva-driver 2h 0.1 mm/h
...
- baseline = VALE do ato: 5.15 m em 14/09 10:23 (DC-RS) · subida até agora 0.0 m
...
|---|---|---|---|---|---|---|
| Oeste | 65.98 → 65.82 | 0.0 | 0.71 | 5A/2F | 19.33 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 65.82 | 5A/2F | 0 | 19.33 m | 14/09 10:26 |
| Barragem Sul Ituporanga | 17.35 | 5A/0F | 0 | 18.7 m | 14/09 10:26 |
...
- **A) SDC-00013:** baseline 5.31 m · pico v1.0 ~5.3 m (banda 4.8–5.8) → **Atenção**
- **B) DC-RS Dom Tito:** baseline 5.15 m · pico v1.0 ~5.2 m (banda 4.7–5.7) → **Atenção**
- **Δ pico (B − A): -0.10 m** · classe inalterada
- nível atual: SDC 5.31 m · DC-RS 5.15 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.1 m
