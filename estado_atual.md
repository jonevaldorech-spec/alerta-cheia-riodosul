# Cheia — Rio do Sul (SC) — 2026-09-12 10:30 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 5.66 m — **ALERTA** · tendência estável/caindo
- SDC-00013: 5.83 m · DC-RS Dom Tito: 5.66 m · offset medido DC-RS−SDC: -0.17 m
**Chuva 24h máx (drivers):** 64.8 mm
**EVENTO ATIVO:** 🔴 SIM

**🎯 MODO CRISTA (nowcast — chuva encerrada, réguas-líder viradas):** pico ~5.66 m → **ALERTA** · crista já atingida/passando
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.022 m/h (anterior -0.023 m/h) · chuva-driver 2h 0.0 mm/h
...
- baseline = VALE do ato: 3.83 m em 11/09 06:42 (DC-RS) · subida até agora 1.83 m
- chuva-jusante do ato: 49.9 mm (ancoras; soma horária desde o vale (28 h, cobertura 100%)) · chuva-acima 60.9 mm
- cj efetiva 88 mm = cj 50 + trânsito-acima 0 (fração de comportas aberta 0.00) + pluviômetro-ΔV 38 (ΔV do ato 53.7 hm³)
...
|---|---|---|---|---|---|---|
| Oeste | 14.87 → 48.27 | 33.4 | 0.00 | 0A/7F | 17.04 m |  |
| Sul | 0.58 → 20.1 | 20.3 | 0.00 | 0A/5F | 19.4 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 48.27 | 0A/7F | 0 | 17.04 m | 12/09 10:26 |
| Barragem Sul Ituporanga | 20.1 | 0A/5F | 0 | 19.4 m | 12/09 10:26 |
...
- nível atual: SDC 5.83 m · DC-RS 5.66 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 4.51 m
