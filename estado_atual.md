# Cheia — Rio do Sul (SC) — 2026-09-08 10:30 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 4.63 m — **ATENÇÃO** · tendência subindo
- SDC-00013: 4.78 m · DC-RS Dom Tito: 4.63 m · offset medido DC-RS−SDC: -0.15 m
...
- baseline = VALE do ato: 3.45 m em 07/09 23:07 (DC-RS) · subida até agora 1.18 m
- chuva-jusante do ato: 0.0 mm (drivers (divergiu -73% das ancoras); soma horária desde o vale (12 h, cobertura 100%)) · chuva-acima 0.0 mm
...
|---|---|---|---|---|---|---|
| Oeste | 10.69 → 5.12 | 0.0 | 1.00 | 7A/0F | 9.23 m |  |
...
|---|---|---|---|---|
| Barragem Oeste Taió | 5.12 | 7A/0F | 0 | 9.23 m |
...
- nível atual: SDC 4.78 m · DC-RS 4.63 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.22 m
