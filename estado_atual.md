# Cheia — Rio do Sul (SC) — 2026-09-16 16:00 (local −03)
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 44.08 | 7A/0F | 0 | 16.46 m | 16/09 15:52 |
| Barragem Sul Ituporanga | 0.0 | 5A/0F | 0 | 4.0 m | 16/09 15:52 |
...
- **A) SDC-00013:** baseline 4.41 m · pico v1.0 ~4.4 m (banda 3.9–4.9) → **Normal**
- **B) DC-RS Dom Tito:** baseline 4.25 m · pico v1.0 ~4.3 m (banda 3.8–4.8) → **Normal**
- **Δ pico (B − A): -0.10 m** · classe inalterada
- nível atual: SDC 4.39 m · DC-RS 4.25 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 3.15 m
