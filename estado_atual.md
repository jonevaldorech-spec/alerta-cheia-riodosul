# Cheia — Rio do Sul (SC) — 2026-09-12 09:30 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 5.68 m — **ALERTA** · tendência estável/caindo
- SDC-00013: 5.85 m · DC-RS Dom Tito: 5.68 m · offset medido DC-RS−SDC: -0.17 m
**Chuva 24h máx (drivers):** 80.4 mm
**EVENTO ATIVO:** 🔴 SIM

**🎯 MODO CRISTA (nowcast — chuva encerrada, réguas-líder viradas):** pico ~5.69 m → **ALERTA** · crista já atingida/passando
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.032 m/h (anterior -0.026 m/h) · chuva-driver 2h 0.0 mm/h
...
- baseline = VALE do ato: 3.83 m em 11/09 06:42 (DC-RS) · subida até agora 1.85 m
- chuva-jusante do ato: 49.9 mm (ancoras; soma horária desde o vale (27 h, cobertura 100%)) · chuva-acima 60.9 mm
- cj efetiva 87 mm = cj 50 + trânsito-acima 0 (fração de comportas aberta 0.00) + pluviômetro-ΔV 37 (ΔV do ato 52.2 hm³)
...
|---|---|---|---|---|---|---|
| Oeste | 14.87 → 47.11 | 32.2 | 0.00 | 0A/7F | 16.88 m |  |
| Sul | 0.58 → 19.77 | 20.0 | 0.00 | 0A/5F | 19.32 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 47.11 | 0A/7F | 0 | 16.88 m | 12/09 09:26 |
| Barragem Sul Ituporanga | 19.77 | 0A/5F | 0 | 19.32 m | 12/09 09:26 |
...
- nível atual: SDC 5.85 m · DC-RS 5.68 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 4.58 m
