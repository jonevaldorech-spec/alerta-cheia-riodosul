# Cheia — Rio do Sul (SC) — 2026-09-14 09:30 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 5.17 m — **ATENÇÃO** · tendência estável/caindo
- SDC-00013: 5.33 m · DC-RS Dom Tito: 5.17 m · offset medido DC-RS−SDC: -0.16 m
**Chuva 24h máx (drivers):** 0.6 mm
**EVENTO ATIVO:** 🔴 SIM

**🎯 MODO CRISTA (nowcast — chuva encerrada, réguas-líder viradas):** pico ~5.18 m → **ATENÇÃO** · crista já atingida/passando
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.03 m/h (anterior -0.026 m/h) · chuva-driver 2h 0.1 mm/h
...
- baseline = VALE do ato: 5.17 m em 14/09 09:24 (DC-RS) · subida até agora 0.0 m
...
|---|---|---|---|---|---|---|
| Oeste | 66.14 → 66.06 | 0.0 | 0.71 | 5A/2F | 19.36 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 66.06 | 5A/2F | 0 | 19.36 m | 14/09 09:26 |
| Barragem Sul Ituporanga | 17.35 | 5A/0F | 0 | 18.7 m | 14/09 09:26 |
...
- **A) SDC-00013:** baseline 5.33 m · pico v1.0 ~5.3 m (banda 4.8–5.8) → **Atenção**
- **B) DC-RS Dom Tito:** baseline 5.17 m · pico v1.0 ~5.2 m (banda 4.7–5.7) → **Atenção**
- **Δ pico (B − A): -0.10 m** · classe inalterada
- nível atual: SDC 5.33 m · DC-RS 5.17 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.12 m
