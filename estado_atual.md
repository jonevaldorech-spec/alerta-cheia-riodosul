# Cheia — Rio do Sul (SC) — 2026-09-14 23:30 (local −03)
...
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual 0.0 m/h (anterior 0.003 m/h) · chuva-driver 2h 0.4 mm/h
...
|---|---|---|---|---|---|---|
| Oeste | 63.99 → 61.68 | 0.0 | 0.97 | 7A/0F | 18.81 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 61.68 | 7A/0F | 0 | 18.81 m | 14/09 23:22 |
| Barragem Sul Ituporanga | 15.52 | 5A/0F | 0 | 18.2 m | 14/09 23:22 |
...
- nível atual: SDC 5.23 m · DC-RS 5.08 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.36 m
