# Cheia — Rio do Sul (SC) — 2026-09-14 11:00 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 5.14 m — **ATENÇÃO** · tendência estável/caindo
- SDC-00013: 5.29 m · DC-RS Dom Tito: 5.14 m · offset medido DC-RS−SDC: -0.15 m
...
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.026 m/h (anterior -0.029 m/h) · chuva-driver 2h 0.1 mm/h
...
**Pico estimado (v1.0 (TETO — modo crista ativo)):** ~5.1 m (banda p10–p90 4.7–5.6 m) → **Atenção**
**Classe que dispara o alerta/e-mail: ATENÇÃO**
- baseline = VALE do ato: 5.14 m em 14/09 10:49 (DC-RS) · subida até agora 0.0 m
...
|---|---|---|---|---|---|---|
| Oeste | 65.82 → 65.66 | 0.0 | 0.71 | 5A/2F | 19.31 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 65.66 | 5A/2F | 0 | 19.31 m | 14/09 10:56 |
| Barragem Sul Ituporanga | 17.35 | 5A/0F | 0 | 18.7 m | 14/09 10:56 |
...
- **A) SDC-00013:** baseline 5.3 m · pico v1.0 ~5.3 m (banda 4.8–5.8) → **Atenção**
- **B) DC-RS Dom Tito:** baseline 5.14 m · pico v1.0 ~5.1 m (banda 4.7–5.6) → **Atenção**
- **Δ pico (B − A): -0.20 m** · classe inalterada
- nível atual: SDC 5.29 m · DC-RS 5.14 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.1 m
