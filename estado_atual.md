# Cheia — Rio do Sul (SC) — 2026-09-08 18:00 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 4.45 m — **Normal** · tendência estável/caindo
- SDC-00013: 4.7 m · DC-RS Dom Tito: 4.45 m · offset medido DC-RS−SDC: -0.25 m
...
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.063 m/h (anterior -0.016 m/h) · chuva-driver 2h 0.0 mm/h
...
|---|---|---|---|---|
| Barragem Oeste Taió | 2.03 | 7A/0F | 0 | 7.39 m |
| Barragem Sul Ituporanga | 6.66 | 5A/0F | 0 | 15.0 m |

## Referência de nível — DC-RS Dom Tito (troca de datum)

Referência ATIVA: **DC-RS (Asthon Ponte Dom Tito)** · offset medido DC-RS−SDC: **-0.25 m** · fallback -0.15 m
...
- nível atual: SDC 4.7 m · DC-RS 4.45 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 4.91 m
