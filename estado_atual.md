# Cheia — Rio do Sul (SC) — 2026-09-13 09:00 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 5.59 m — **ALERTA** · tendência estável/caindo
- SDC-00013: 5.76 m · DC-RS Dom Tito: 5.59 m · offset medido DC-RS−SDC: -0.17 m
**Chuva 24h máx (drivers):** 2.4 mm
**EVENTO ATIVO:** 🔴 SIM

**🎯 MODO CRISTA (nowcast — chuva encerrada, réguas-líder viradas):** pico ~5.59 m → **ALERTA** · crista já atingida/passando
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.023 m/h (anterior -0.007 m/h) · chuva-driver 2h 0.2 mm/h
...
- baseline = VALE do ato: 5.47 m em 12/09 18:19 (DC-RS) · subida até agora 0.12 m
- chuva-jusante do ato: 0.5 mm (ancoras; soma horária desde o vale (15 h, cobertura 100%)) · chuva-acima 1.7 mm
- cj efetiva 6 mm = cj 0 + trânsito-acima 0 (fração de comportas aberta 0.20) + pluviômetro-ΔV 5 (ΔV do ato 7.4 hm³)
...
|---|---|---|---|---|---|---|
| Oeste | 55.44 → 62.87 | 7.4 | 0.00 | 0A/7F | 18.96 m |  |
| Sul | 21.37 → 20.92 | 0.0 | 0.40 | 2A/3F | 19.59 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 62.87 | 0A/7F | 0 | 18.96 m | 13/09 08:56 |
| Barragem Sul Ituporanga | 20.92 | 2A/3F | 0 | 19.59 m | 13/09 08:56 |
...
- nível atual: SDC 5.76 m · DC-RS 5.59 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 4.78 m
