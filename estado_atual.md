# Cheia — Rio do Sul (SC) — 2026-09-14 08:30 (local −03)
...
**Pico estimado (v1.0, OFICIAL):** ~5.2 m (banda p10–p90 4.7–5.7 m) → **Atenção**
**Classe que dispara o alerta/e-mail: Atenção**
- baseline = VALE do ato: 5.21 m em 14/09 08:17 (DC-RS) · subida até agora 0.0 m
...
- cj efetiva 0 mm = cj 0 + trânsito-acima 0 (fração de comportas aberta 0.55) + pluviômetro-ΔV 0 (ΔV do ato 0.0 hm³)
...
|---|---|---|---|---|---|---|
| Oeste | 66.3 → 66.3 | 0.0 | 0.29 | 2A/5F | 19.39 m |  |
| Sul | 17.35 → 17.35 | 0.0 | 0.80 | 4A/1F | 18.7 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 66.3 | 2A/5F | 0 | 19.39 m | 14/09 08:26 |
| Barragem Sul Ituporanga | 17.35 | 4A/1F | 0 | 18.7 m | 14/09 08:26 |
...
- **A) SDC-00013:** baseline 5.37 m · pico v1.0 ~5.4 m (banda 4.9–5.9) → **Atenção**
- **B) DC-RS Dom Tito:** baseline 5.21 m · pico v1.0 ~5.2 m (banda 4.7–5.7) → **Atenção**
- **Δ pico (B − A): -0.20 m** · classe inalterada
- nível atual: SDC 5.37 m · DC-RS 5.21 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.08 m
