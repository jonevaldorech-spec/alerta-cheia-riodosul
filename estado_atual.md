# Cheia — Rio do Sul (SC) — 2026-09-10 20:30 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 4.16 m — **Normal** · tendência estável/caindo
- SDC-00013: 4.31 m · DC-RS Dom Tito: 4.16 m · offset medido DC-RS−SDC: -0.15 m
**Chuva 24h máx (drivers):** 83.8 mm
**EVENTO ATIVO:** 🔴 SIM

**🎯 MODO CRISTA (nowcast — chuva encerrada, réguas-líder viradas):** pico ~4.17 m → **Normal** · crista já atingida/passando
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.053 m/h (anterior -0.008 m/h) · chuva-driver 2h 1.7 mm/h
...
- baseline = VALE do ato: 2.93 m em 09/09 23:09 (DC-RS) · subida até agora 1.23 m
- chuva-jusante do ato: 39.3 mm (drivers (divergiu -20% das ancoras); soma horária desde o vale (22 h, cobertura 100%)) · chuva-acima 39.4 mm
- cj efetiva 52 mm = cj 39 + trânsito-acima 12 (fração de comportas aberta 0.74) + pluviômetro-ΔV 0 (ΔV do ato 0.6 hm³)
...
|---|---|---|---|---|---|---|
| Oeste | 41.84 → 11.08 | 0.0 | 0.84 | 0A/7F | 10.91 m |  |
| Sul | 0.0 → 0.58 | 0.6 | 0.65 | 0A/5F | 9.5 m |  |
...
_Chuva-acima (contexto de barragem, fora do cj):_ Taio_montante 49.8, Rio do Campo 44.0, Alfredo Wagner 24.4

## Barragens (Asthon)

| Barragem | % uso | Comportas | Vertido | Montante |
|---|---|---|---|---|
| Barragem Oeste Taió | 11.08 | 0A/7F | 0 | 10.91 m |
...
- nível atual: SDC 4.31 m · DC-RS 4.16 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 3.1 m
