# Cheia — Rio do Sul (SC) — 2026-09-14 12:00 (local −03)
...
**🎯 MODO CRISTA (nowcast — chuva encerrada, réguas-líder viradas):** pico ~5.12 m → **ATENÇÃO** · crista já atingida/passando
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.032 m/h (anterior -0.029 m/h) · chuva-driver 2h 0.1 mm/h
...
- baseline = VALE do ato: 5.1 m em 14/09 11:58 (DC-RS) · subida até agora 0.0 m
...
|---|---|---|---|---|---|---|
| Oeste | 65.58 → 65.5 | 0.0 | 0.71 | 5A/2F | 19.29 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 65.5 | 5A/2F | 0 | 19.29 m | 14/09 11:56 |
| Barragem Sul Ituporanga | 17.35 | 5A/0F | 0 | 18.7 m | 14/09 11:56 |
...
- **A) SDC-00013:** baseline 5.26 m · pico v1.0 ~5.3 m (banda 4.8–5.8) → **Atenção**
- **B) DC-RS Dom Tito:** baseline 5.1 m · pico v1.0 ~5.1 m (banda 4.6–5.6) → **Atenção**
- **Δ pico (B − A): -0.20 m** · classe inalterada
- nível atual: SDC 5.27 m · DC-RS 5.1 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.1 m
