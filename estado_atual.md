# Cheia — Rio do Sul (SC) — 2026-09-08 17:00 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 4.56 m — **ATENÇÃO** · tendência estável/caindo
- SDC-00013: 4.7 m · DC-RS Dom Tito: 4.56 m · offset medido DC-RS−SDC: -0.14 m
...
- baseline = VALE do ato: 3.45 m em 07/09 23:07 (DC-RS) · subida até agora 1.11 m
...
|---|---|---|---|---|---|---|
| Oeste | 10.69 → 2.38 | 0.0 | 1.00 | 7A/0F | 7.7 m |  |
...
- nível atual: SDC 4.7 m · DC-RS 4.56 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 4.96 m
