# Cheia — Rio do Sul (SC) — 2026-09-12 02:00 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 5.85 m — **ALERTA** · tendência estável/caindo
- SDC-00013: 6.04 m · DC-RS Dom Tito: 5.85 m · offset medido DC-RS−SDC: -0.19 m
**Chuva 24h máx (drivers):** 80.8 mm
**EVENTO ATIVO:** 🔴 SIM

**🎯 MODO CRISTA (nowcast — chuva encerrada, réguas-líder viradas):** pico ~5.86 m → **ALERTA** · crista já atingida/passando
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.013 m/h (anterior 0.017 m/h) · chuva-driver 2h 0.0 mm/h
...
- cj efetiva 70 mm = cj 50 + trânsito-acima 0 (fração de comportas aberta 0.00) + pluviômetro-ΔV 20 (ΔV do ato 28.6 hm³)
...
|---|---|---|---|---|---|---|
| Oeste | 14.87 → 36.07 | 21.2 | 0.00 | 0A/7F | 15.31 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 36.07 | 0A/7F | 0 | 15.31 m | 12/09 01:56 |
| Barragem Sul Ituporanga | 7.72 | 0A/5F | 0 | 15.5 m | 12/09 01:56 |
...
- **A) SDC-00013:** baseline 3.98 m · pico v1.0 ~6.0 m (banda 5.6–6.5) → **Alerta**
- **B) DC-RS Dom Tito:** baseline 3.83 m · pico v1.0 ~5.9 m (banda 5.4–6.4) → **Alerta**
- **Δ pico (B − A): -0.10 m** · classe inalterada
- nível atual: SDC 6.04 m · DC-RS 5.85 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.25 m
