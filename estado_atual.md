# Cheia — Rio do Sul (SC) — 2026-09-13 11:00 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 5.56 m — **ALERTA** · tendência estável/caindo
- SDC-00013: 5.72 m · DC-RS Dom Tito: 5.56 m · offset medido DC-RS−SDC: -0.16 m
...
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.018 m/h (anterior -0.02 m/h) · chuva-driver 2h 0.1 mm/h
...
- chuva-jusante do ato: 0.5 mm (ancoras; soma horária desde o vale (17 h, cobertura 100%)) · chuva-acima 1.7 mm
- cj efetiva 6 mm = cj 0 + trânsito-acima 0 (fração de comportas aberta 0.20) + pluviômetro-ΔV 6 (ΔV do ato 8.1 hm³)
...
|---|---|---|---|---|---|---|
| Oeste | 55.44 → 63.59 | 8.1 | 0.00 | 0A/7F | 19.05 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 63.59 | 0A/7F | 0 | 19.05 m | 13/09 10:56 |
| Barragem Sul Ituporanga | 20.84 | 2A/3F | 0 | 19.57 m | 13/09 10:56 |
...
- nível atual: SDC 5.72 m · DC-RS 5.56 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 4.74 m
