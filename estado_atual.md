# Cheia — Rio do Sul (SC) — 2026-09-13 04:00 (local −03)
...
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.007 m/h (anterior 0.009 m/h) · chuva-driver 2h 1.0 mm/h
...
- chuva-jusante do ato: 0.5 mm (drivers (divergiu +56% das ancoras); soma horária desde o vale (11 h, cobertura 100%)) · chuva-acima 1.5 mm
- cj efetiva 5 mm = cj 1 + trânsito-acima 0 (fração de comportas aberta 0.20) + pluviômetro-ΔV 4 (ΔV do ato 5.4 hm³)
...
|---|---|---|---|---|---|---|
| Oeste | 55.44 → 60.88 | 5.4 | 0.00 | 0A/7F | 18.71 m |  |
| Sul | 21.37 → 21.21 | 0.0 | 0.40 | 2A/3F | 19.65 m |  |
...
_Chuva-acima (contexto de barragem, fora do cj):_ Taio_montante 4.2, Rio do Campo 0.3, Alfredo Wagner 0.0

## Barragens (Asthon)

| Barragem | % uso | Comportas | Vertido | Montante | Medida em |
|---|---|---|---|---|---|
| Barragem Oeste Taió | 60.88 | 0A/7F | 0 | 18.71 m | 13/09 03:56 |
| Barragem Sul Ituporanga | 21.21 | 2A/3F | 0 | 19.65 m | 13/09 03:56 |
