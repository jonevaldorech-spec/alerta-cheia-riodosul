# Cheia — Rio do Sul (SC) — 2026-09-13 09:30 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 5.58 m — **ALERTA** · tendência estável/caindo
- SDC-00013: 5.75 m · DC-RS Dom Tito: 5.58 m · offset medido DC-RS−SDC: -0.17 m
**Chuva 24h máx (drivers):** 2.4 mm
**EVENTO ATIVO:** 🔴 SIM

**Pico estimado (v1.0, OFICIAL):** ~5.6 m (banda p10–p90 5.1–6.1 m) → **Alerta**
**Classe que dispara o alerta/e-mail: Alerta**
- baseline = VALE do ato: 5.47 m em 12/09 18:19 (DC-RS) · subida até agora 0.11 m
- chuva-jusante do ato: 0.5 mm (drivers (divergiu +11% das ancoras); soma horária desde o vale (15 h, cobertura 99%)) · chuva-acima 1.7 mm
- cj efetiva 6 mm = cj 1 + trânsito-acima 0 (fração de comportas aberta 0.20) + pluviômetro-ΔV 5 (ΔV do ato 7.6 hm³)
...
|---|---|---|---|---|---|---|
| Oeste | 55.44 → 63.03 | 7.6 | 0.00 | 0A/7F | 18.98 m |  |
| Sul | 21.37 → 20.92 | 0.0 | 0.40 | 2A/3F | 19.59 m |  |

## Chuva-jusante fundida DO ATO — soma horária desde o vale (15 h, cobertura 99%)
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 63.03 | 0A/7F | 0 | 18.98 m | 13/09 09:26 |
| Barragem Sul Ituporanga | 20.92 | 2A/3F | 0 | 19.59 m | 13/09 09:26 |
...
- nível atual: SDC 5.75 m · DC-RS 5.58 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 4.75 m
