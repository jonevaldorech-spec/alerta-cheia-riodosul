# Cheia — Rio do Sul (SC) — 2026-09-14 21:30 (local −03)
...
- chuva-jusante do ato: 0.0 mm (drivers (divergiu -73% das ancoras); soma horária desde o vale (4 h, cobertura 100%)) · chuva-acima 0.3 mm
- cj efetiva 0 mm = cj 0 + trânsito-acima 0 (fração de comportas aberta 0.97) + pluviômetro-ΔV 0 (ΔV do ato 0.0 hm³)
...
|---|---|---|---|---|---|---|
| Oeste | 63.99 → 62.55 | 0.0 | 0.95 | 7A/0F | 18.92 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 62.55 | 7A/0F | 0 | 18.92 m | 14/09 21:22 |
| Barragem Sul Ituporanga | 15.52 | 5A/0F | 0 | 18.2 m | 14/09 21:22 |
...
- nível atual: SDC 5.22 m · DC-RS 5.06 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.32 m
