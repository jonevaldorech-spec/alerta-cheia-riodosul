# Cheia — Rio do Sul (SC) — 2026-09-12 16:00 (local −03)
...
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.021 m/h (anterior -0.03 m/h) · chuva-driver 2h 0.1 mm/h
...
- baseline = VALE do ato: 5.52 m em 12/09 15:53 (DC-RS) · subida até agora 0.01 m
...
- cj efetiva 0 mm = cj 0 + trânsito-acima 0 (fração de comportas aberta 0.20) + pluviômetro-ΔV 0 (ΔV do ato 0.4 hm³)
...
|---|---|---|---|---|---|---|
| Oeste | 53.39 → 53.77 | 0.4 | 0.00 | 0A/7F | 17.78 m |  |
| Sul | 21.33 → 21.37 | 0.0 | 0.40 | 2A/3F | 19.7 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 53.77 | 0A/7F | 0 | 17.78 m | 12/09 15:56 |
| Barragem Sul Ituporanga | 21.37 | 2A/3F | 0 | 19.7 m | 12/09 15:56 |
...
- **A) SDC-00013:** baseline 5.68 m · pico v1.0 ~5.7 m (banda 5.2–6.2) → **Alerta**
- **B) DC-RS Dom Tito:** baseline 5.52 m · pico v1.0 ~5.5 m (banda 5.0–6.0) → **Alerta**
- **Δ pico (B − A): -0.20 m** · classe inalterada
- nível atual: SDC 5.7 m · DC-RS 5.53 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 4.29 m
