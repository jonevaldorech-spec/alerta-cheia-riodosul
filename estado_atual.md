# Cheia — Rio do Sul (SC) — 2026-09-05 05:30 (local −03)
...
|---|---|---|---|---|---|---|
| Oeste | 35.11% (curva 35.9%) | 15.59→15.19 | -0.05 | 0.0 | 0.0 | ⚠ 0 — não está enchendo (taxa ≤ 0) — sem crédito |
| Sul | 39.73% (curva 40.2%) | 24.01→23.37 | -0.08 | 0.0 | 0.0 | ⚠ 0 — não está enchendo (taxa ≤ 0) — sem crédito |
...
_Chuva-acima (contexto de barragem, fora do cj):_ Taio_montante 13.6, Rio do Campo 8.1, Alfredo Wagner 0.1

## Barragens (Asthon)

| Barragem | % uso | Comportas | Vertido | Montante |
|---|---|---|---|---|
| Barragem Oeste Taió | 35.11 | 7A/0F | 0 | 15.17 m |
| Barragem Sul Ituporanga | 39.73 | 5A/0F | 0 | 23.33 m |
...
- nível atual: SDC 5.42 m · DC-RS 5.26 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.5 m
