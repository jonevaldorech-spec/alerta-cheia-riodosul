# Cheia — Rio do Sul (SC) — 2026-09-07 10:00 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 4.8 m — **ATENÇÃO** · tendência estável/caindo
- SDC-00013: 4.95 m · DC-RS Dom Tito: 4.8 m · offset medido DC-RS−SDC: -0.15 m
**Chuva 24h máx (drivers):** 0.1 mm
**EVENTO ATIVO:** 🔴 SIM

**Pico estimado (v1.0, OFICIAL):** ~4.8 m (banda p10–p90 4.3–5.3 m) → **Atenção**
**Classe que dispara o alerta/e-mail: Atenção**
- baseline = VALE do ato: 4.79 m em 07/09 09:58 (DC-RS) · subida até agora 0.01 m
...
- sombra (cj_lat, c/ laterais): ~4.8 m (cj 0 mm · Δcj_lat−cj_v07 = 0.0 mm, n_laterais=4)
...
|---|---|---|---|---|---|---|
| Oeste | 15.62 → 15.42 | 0.0 | 1.00 | 7A/0F | 11.84 m |  |
...
|---|---|---|---|---|
| Barragem Oeste Taió | 15.42 | 7A/0F | 0 | 11.84 m |
...
- **A) SDC-00013:** baseline 4.95 m · pico v1.0 ~5.0 m (banda 4.5–5.5) → **Atenção**
- **B) DC-RS Dom Tito:** baseline 4.79 m · pico v1.0 ~4.8 m (banda 4.3–5.3) → **Atenção**
- **Δ pico (B − A): -0.20 m** · classe inalterada
- nível atual: SDC 4.95 m · DC-RS 4.8 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 4.25 m
