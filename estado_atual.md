# Cheia — Rio do Sul (SC) — 2026-09-08 08:30 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 4.59 m — **ATENÇÃO** · tendência subindo
- SDC-00013: 4.73 m · DC-RS Dom Tito: 4.59 m · offset medido DC-RS−SDC: -0.14 m
...
- chuva-jusante do ato: 0.0 mm (drivers (divergiu -73% das ancoras); soma horária desde o vale (10 h, cobertura 100%)) · chuva-acima 0.0 mm
...
|---|---|---|---|---|---|---|
| Oeste | 10.69 → 6.12 | 0.0 | 1.00 | 7A/0F | 9.58 m |  |
...
|---|---|---|---|---|
| Barragem Oeste Taió | 6.12 | 7A/0F | 0 | 9.58 m |
...
- nível atual: SDC 4.73 m · DC-RS 4.59 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.22 m
