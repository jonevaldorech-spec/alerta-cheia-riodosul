# Cheia — Rio do Sul (SC) — 2026-09-08 18:30 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 4.45 m — **Normal** · tendência subindo
- SDC-00013: 4.68 m · DC-RS Dom Tito: 4.45 m · offset medido DC-RS−SDC: -0.23 m
...
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.057 m/h (anterior -0.013 m/h) · chuva-driver 2h 0.0 mm/h
...
|---|---|---|---|---|
| Barragem Oeste Taió | 1.89 | 7A/0F | 0 | 7.24 m |
| Barragem Sul Ituporanga | 6.66 | 5A/0F | 0 | 15.0 m |

## Referência de nível — DC-RS Dom Tito (troca de datum)

Referência ATIVA: **DC-RS (Asthon Ponte Dom Tito)** · offset medido DC-RS−SDC: **-0.23 m** · fallback -0.15 m
...
- nível atual: SDC 4.68 m · DC-RS 4.45 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 4.89 m
