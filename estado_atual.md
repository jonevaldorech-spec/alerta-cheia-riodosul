# Cheia — Rio do Sul (SC) — 2026-09-14 23:00 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 5.08 m — **ATENÇÃO** · tendência subindo
...
- chuva-jusante do ato: 0.0 mm (drivers (divergiu -66% das ancoras); soma horária desde o vale (6 h, cobertura 100%)) · chuva-acima 0.3 mm
...
|---|---|---|---|---|---|---|
| Oeste | 63.99 → 61.92 | 0.0 | 0.97 | 7A/0F | 18.84 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 61.92 | 7A/0F | 0 | 18.84 m | 14/09 22:52 |
| Barragem Sul Ituporanga | 15.52 | 5A/0F | 0 | 18.2 m | 14/09 22:52 |
...
- nível atual: SDC 5.23 m · DC-RS 5.08 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.34 m
