# Cheia — Rio do Sul (SC) — 2026-09-13 13:00 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 5.5 m — **ALERTA** · tendência estável/caindo
- SDC-00013: 5.68 m · DC-RS Dom Tito: 5.5 m · offset medido DC-RS−SDC: -0.18 m
...
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.029 m/h (anterior -0.018 m/h) · chuva-driver 2h 0.0 mm/h
...
- chuva-jusante do ato: 0.5 mm (drivers (divergiu +11% das ancoras); soma horária desde o vale (19 h, cobertura 100%)) · chuva-acima 1.7 mm
- cj efetiva 7 mm = cj 1 + trânsito-acima 0 (fração de comportas aberta 0.20) + pluviômetro-ΔV 6 (ΔV do ato 8.9 hm³)
...
|---|---|---|---|---|---|---|
| Oeste | 55.44 → 64.31 | 8.9 | 0.00 | 0A/7F | 19.14 m |  |
| Sul | 21.37 → 20.72 | 0.0 | 0.40 | 2A/3F | 19.54 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 64.31 | 0A/7F | 0 | 19.14 m | 13/09 12:56 |
| Barragem Sul Ituporanga | 20.72 | 2A/3F | 0 | 19.54 m | 13/09 12:56 |
...
- nível atual: SDC 5.68 m · DC-RS 5.5 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 4.7 m
