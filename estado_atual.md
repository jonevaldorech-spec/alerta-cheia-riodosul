# Cheia — Rio do Sul (SC) — 2026-09-15 00:00 (local −03)
...
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual 0.0 m/h (anterior 0.01 m/h) · chuva-driver 2h 0.2 mm/h
...
- chuva-jusante do ato: 0.0 mm (drivers (divergiu -66% das ancoras); soma horária desde o vale (7 h, cobertura 100%)) · chuva-acima 0.3 mm
...
|---|---|---|---|---|---|---|
| Oeste | 63.99 → 61.44 | 0.0 | 0.97 | 7A/0F | 18.78 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 61.44 | 7A/0F | 0 | 18.78 m | 14/09 23:52 |
| Barragem Sul Ituporanga | 15.52 | 5A/0F | 0 | 18.2 m | 14/09 23:52 |
