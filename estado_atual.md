# Cheia — Rio do Sul (SC) — 2026-09-15 16:30 (local −03)
...
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.007 m/h (anterior -0.002 m/h) · chuva-driver 2h 0.1 mm/h
...
- baseline = VALE do ato: 5.02 m em 15/09 16:17 (DC-RS) · subida até agora 0.01 m
...
|---|---|---|---|---|---|---|
| Oeste | 54.45 → 54.23 | 0.0 | 1.00 | 7A/0F | 17.84 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 54.23 | 7A/0F | 0 | 17.84 m | 15/09 16:22 |
| Barragem Sul Ituporanga | 7.72 | 5A/0F | 0 | 15.5 m | 15/09 16:22 |
...
- nível atual: SDC 5.18 m · DC-RS 5.03 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.0 m
