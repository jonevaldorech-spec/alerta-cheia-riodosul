# Cheia — Rio do Sul (SC) — 2026-09-13 05:30 (local −03)
...
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.01 m/h (anterior 0.003 m/h) · chuva-driver 2h 1.0 mm/h
...
- chuva-jusante do ato: 0.5 mm (drivers (divergiu +26% das ancoras); soma horária desde o vale (12 h, cobertura 100%)) · chuva-acima 1.6 mm
- cj efetiva 5 mm = cj 0 + trânsito-acima 0 (fração de comportas aberta 0.20) + pluviômetro-ΔV 4 (ΔV do ato 6.1 hm³)
...
|---|---|---|---|---|---|---|
| Oeste | 55.44 → 61.52 | 6.1 | 0.00 | 0A/7F | 18.79 m |  |
...
_Chuva-acima (contexto de barragem, fora do cj):_ Taio_montante 4.0, Rio do Campo 0.8, Alfredo Wagner 0.0

## Barragens (Asthon)

| Barragem | % uso | Comportas | Vertido | Montante | Medida em |
|---|---|---|---|---|---|
| Barragem Oeste Taió | 61.52 | 0A/7F | 0 | 18.79 m | 13/09 05:26 |
| Barragem Sul Ituporanga | 21.13 | 2A/3F | 0 | 19.64 m | 13/09 05:26 |
...
- nível atual: SDC 5.81 m · DC-RS 5.64 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 4.84 m
