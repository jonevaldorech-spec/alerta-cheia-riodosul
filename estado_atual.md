# Cheia — Rio do Sul (SC) — 2026-09-11 23:30 (local −03)
...
**🎯 MODO CRISTA (nowcast — chuva encerrada, réguas-líder viradas):** pico ~5.89 m → **ALERTA** · crista em ~0 h
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual 0.026 m/h (anterior 0.099 m/h) · chuva-driver 2h 0.0 mm/h
...
**Pico estimado (v1.0 (TETO — modo crista ativo)):** ~5.8 m (banda p10–p90 5.4–6.3 m) → **Alerta**
...
- cj efetiva 67 mm = cj 50 + trânsito-acima 0 (fração de comportas aberta 0.00) + pluviômetro-ΔV 18 (ΔV do ato 24.7 hm³)
...
|---|---|---|---|---|---|---|
| Oeste | 14.87 → 32.18 | 17.3 | 0.00 | 0A/7F | 14.72 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 32.18 | 0A/7F | 0 | 14.72 m | 11/09 23:26 |
| Barragem Sul Ituporanga | 7.72 | 0A/5F | 0 | 15.5 m | 11/09 23:26 |
...
- **B) DC-RS Dom Tito:** baseline 3.83 m · pico v1.0 ~5.8 m (banda 5.4–6.3) → **Alerta**
- **Δ pico (B − A): -0.20 m** · classe inalterada
- nível atual: SDC 6.05 m · DC-RS 5.88 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.49 m
