# Cheia — Rio do Sul (SC) — 2026-09-10 12:30 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 4.12 m — **Normal** · tendência subindo
- SDC-00013: 4.26 m · DC-RS Dom Tito: 4.12 m · offset medido DC-RS−SDC: -0.14 m
**Chuva 24h máx (drivers):** 83.4 mm
**EVENTO ATIVO:** 🔴 SIM

**🎯 MODO CRISTA (nowcast — chuva encerrada, réguas-líder viradas):** pico ~4.13 m → **Normal** · crista em ~1 h
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual 0.087 m/h (anterior 0.122 m/h) · chuva-driver 2h 0.0 mm/h
...
- baseline = VALE do ato: 2.93 m em 09/09 23:09 (DC-RS) · subida até agora 1.19 m
- chuva-jusante do ato: 38.3 mm (drivers (divergiu -20% das ancoras); soma horária desde o vale (14 h, cobertura 100%)) · chuva-acima 36.9 mm
...
- nível atual: SDC 4.26 m · DC-RS 4.12 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 4.3 m
