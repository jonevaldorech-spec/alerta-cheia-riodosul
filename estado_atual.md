# Cheia — Rio do Sul (SC) — 2026-09-07 09:15 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 4.91 m — **ATENÇÃO** · tendência estável/caindo
- SDC-00013: 5.06 m · DC-RS Dom Tito: 4.91 m · offset medido DC-RS−SDC: -0.15 m
**Chuva 24h máx (drivers):** 0.1 mm
**EVENTO ATIVO:** 🔴 SIM

**Pico estimado (v1.0, OFICIAL):** ~4.9 m (banda p10–p90 4.4–5.4 m) → **Atenção**
**Classe que dispara o alerta/e-mail: Atenção**
- baseline = VALE do ato: 4.92 m em 07/09 09:07 (DC-RS) · subida até agora -0.009999999999999787 m
...
- sombra (cj_lat, c/ laterais): ~4.9 m (cj 0 mm · Δcj_lat−cj_v07 = 0.0 mm, n_laterais=4)
...
|---|---|---|---|---|---|---|
| Oeste | 15.83 → 15.73 | 0.0 | 1.00 | 7A/0F | 11.9 m |  |
...
|---|---|---|---|---|
| Barragem Oeste Taió | 15.73 | 7A/0F | 0 | 11.9 m |
...
- **A) SDC-00013:** baseline 5.08 m · pico v1.0 ~5.1 m (banda 4.6–5.6) → **Atenção**
- **B) DC-RS Dom Tito:** baseline 4.92 m · pico v1.0 ~4.9 m (banda 4.4–5.4) → **Atenção**
- **Δ pico (B − A): -0.20 m** · classe inalterada
- nível atual: SDC 5.06 m · DC-RS 4.91 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 4.63 m
