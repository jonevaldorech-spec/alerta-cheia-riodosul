# Cheia — Rio do Sul (SC) — 2026-09-10 08:00 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 3.65 m — **Normal** · tendência subindo
...
- baseline = VALE do ato: 2.93 m em 09/09 23:09 (DC-RS) · subida até agora 0.72 m
- chuva-jusante do ato: 38.7 mm (drivers (divergiu -19% das ancoras); soma horária desde o vale (10 h, cobertura 100%)) · chuva-acima 36.4 mm
...
_Chuva-acima (contexto de barragem, fora do cj):_ Taio_montante 47.2, Rio do Campo 38.1, Alfredo Wagner 23.9
...
- nível atual: SDC 3.79 m · DC-RS 3.65 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 3.49 m
