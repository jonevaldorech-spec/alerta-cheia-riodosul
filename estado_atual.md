# Cheia — Rio do Sul (SC) — 2026-09-16 14:30 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 4.29 m — **Normal** · tendência estável/caindo
- SDC-00013: 4.43 m · DC-RS Dom Tito: 4.29 m · offset medido DC-RS−SDC: -0.14 m
...
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.025 m/h (anterior -0.031 m/h) · chuva-driver 2h 0.0 mm/h
- réguas-líder: Pouso Redondo: subindo · Trombudo Central: virou · Agrolandia: virou
- o v1.0 vira **TETO** (~4.3 m); o número acima é o nowcast e DECIDE o alerta.
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 44.87 | 7A/0F | 0 | 16.57 m | 16/09 14:22 |
| Barragem Sul Ituporanga | 0.0 | 5A/0F | 0 | 4.0 m | 16/09 14:22 |
...
- **A) SDC-00013:** baseline 4.45 m · pico v1.0 ~4.5 m (banda 4.0–5.0) → **Normal**
- **B) DC-RS Dom Tito:** baseline 4.29 m · pico v1.0 ~4.3 m (banda 3.8–4.8) → **Normal**
- **Δ pico (B − A): -0.20 m** · classe inalterada
- nível atual: SDC 4.43 m · DC-RS 4.29 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 3.33 m
