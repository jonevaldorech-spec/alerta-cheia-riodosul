# Cheia — Rio do Sul (SC) — 2026-09-15 21:00 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 4.99 m — **ATENÇÃO** · tendência estável/caindo
- SDC-00013: 5.16 m · DC-RS Dom Tito: 4.99 m · offset medido DC-RS−SDC: -0.17 m
**Chuva 24h máx (drivers):** 0.5 mm
**EVENTO ATIVO:** 🔴 SIM

**Pico estimado (v1.0, OFICIAL):** ~5.0 m (banda p10–p90 4.5–5.5 m) → **Atenção**
**Classe que dispara o alerta/e-mail: Atenção**
- baseline = VALE do ato: 4.99 m em 15/09 20:49 (DC-RS) · subida até agora 0.0 m
...
|---|---|---|---|---|---|---|
| Oeste | 52.64 → 52.48 | 0.0 | 1.00 | 7A/0F | 17.61 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 52.48 | 7A/0F | 0 | 17.61 m | 15/09 20:52 |
| Barragem Sul Ituporanga | 1.01 | 5A/0F | 0 | 10.3 m | 15/09 20:52 |
...
- **A) SDC-00013:** baseline 5.15 m · pico v1.0 ~5.2 m (banda 4.7–5.7) → **Atenção**
- **B) DC-RS Dom Tito:** baseline 4.99 m · pico v1.0 ~5.0 m (banda 4.5–5.5) → **Atenção**
- **Δ pico (B − A): -0.20 m** · classe inalterada
- nível atual: SDC 5.16 m · DC-RS 4.99 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 4.84 m
