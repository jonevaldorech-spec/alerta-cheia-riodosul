# Cheia — Rio do Sul (SC) — 2026-09-14 10:00 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 5.16 m — **ATENÇÃO** · tendência estável/caindo
- SDC-00013: 5.33 m · DC-RS Dom Tito: 5.16 m · offset medido DC-RS−SDC: -0.17 m
**Chuva 24h máx (drivers):** 0.6 mm
**EVENTO ATIVO:** 🔴 SIM

**🎯 MODO CRISTA (nowcast — chuva encerrada, réguas-líder viradas):** pico ~5.17 m → **ATENÇÃO** · crista já atingida/passando
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.029 m/h (anterior -0.022 m/h) · chuva-driver 2h 0.1 mm/h
...
- baseline = VALE do ato: 5.16 m em 14/09 09:54 (DC-RS) · subida até agora 0.0 m
...
|---|---|---|---|---|---|---|
| Oeste | 66.06 → 65.98 | 0.0 | 0.71 | 5A/2F | 19.35 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 65.98 | 5A/2F | 0 | 19.35 m | 14/09 09:56 |
| Barragem Sul Ituporanga | 17.35 | 5A/0F | 0 | 18.7 m | 14/09 09:56 |
...
- **A) SDC-00013:** baseline 5.32 m · pico v1.0 ~5.3 m (banda 4.8–5.8) → **Atenção**
- **B) DC-RS Dom Tito:** baseline 5.16 m · pico v1.0 ~5.2 m (banda 4.7–5.7) → **Atenção**
- **Δ pico (B − A): -0.10 m** · classe inalterada
- nível atual: SDC 5.33 m · DC-RS 5.16 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.11 m
