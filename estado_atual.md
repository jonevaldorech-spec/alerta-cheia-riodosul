# Cheia — Rio do Sul (SC) — 2026-09-14 22:00 (local −03)
...
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual 0.01 m/h (anterior -0.003 m/h) · chuva-driver 2h 0.6 mm/h
...
- chuva-jusante do ato: 0.1 mm (drivers (divergiu -68% das ancoras); soma horária desde o vale (5 h, cobertura 100%)) · chuva-acima 0.6 mm
...
|---|---|---|---|---|---|---|
| Oeste | 63.99 → 62.4 | 0.0 | 0.96 | 7A/0F | 18.9 m |  |
...
_Chuva-acima (contexto de barragem, fora do cj):_ Rio do Campo 1.6, Alfredo Wagner 0.1, Taio_montante 0.0

## Barragens (Asthon)

| Barragem | % uso | Comportas | Vertido | Montante | Medida em |
|---|---|---|---|---|---|
| Barragem Oeste Taió | 62.4 | 7A/0F | 0 | 18.9 m | 14/09 21:52 |
| Barragem Sul Ituporanga | 15.52 | 5A/0F | 0 | 18.2 m | 14/09 21:52 |
...
- nível atual: SDC 5.23 m · DC-RS 5.08 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.33 m
