# Cheia — Rio do Sul (SC) — 2026-09-14 18:00 (local −03)
...
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.001 m/h (anterior -0.007 m/h) · chuva-driver 2h 0.1 mm/h
...
- baseline = VALE do ato: 5.06 m em 14/09 14:56 (DC-RS) · subida até agora 0.0 m
- chuva-jusante do ato: 0.0 mm (drivers (divergiu -73% das ancoras); soma horária desde o vale (4 h, cobertura 100%)) · chuva-acima 0.0 mm
...
|---|---|---|---|---|---|---|
| Oeste | 64.86 → 63.99 | 0.0 | 0.71 | 5A/2F | 19.1 m |  |
| Sul | 17.35 → 15.52 | 0.0 | 1.00 | 5A/0F | 18.2 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 63.99 | 5A/2F | 0 | 19.1 m | 14/09 17:53 |
| Barragem Sul Ituporanga | 15.52 | 5A/0F | 0 | 18.2 m | 14/09 17:52 |
...
- nível atual: SDC 5.22 m · DC-RS 5.06 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.24 m
