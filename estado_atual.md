# Cheia — Rio do Sul (SC) — 2026-09-12 02:30 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 5.85 m — **ALERTA** · tendência estável/caindo
- SDC-00013: 6.02 m · DC-RS Dom Tito: 5.85 m · offset medido DC-RS−SDC: -0.17 m
**Chuva 24h máx (drivers):** 80.8 mm
**EVENTO ATIVO:** 🔴 SIM

**🎯 MODO CRISTA (nowcast — chuva encerrada, réguas-líder viradas):** pico ~5.85 m → **ALERTA** · crista já atingida/passando
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.019 m/h (anterior 0.009 m/h) · chuva-driver 2h 0.0 mm/h
...
- chuva-jusante do ato: 49.8 mm (ancoras; soma horária desde o vale (20 h, cobertura 100%)) · chuva-acima 60.8 mm
- cj efetiva 71 mm = cj 50 + trânsito-acima 0 (fração de comportas aberta 0.00) + pluviômetro-ΔV 21 (ΔV do ato 29.4 hm³)
...
|---|---|---|---|---|---|---|
| Oeste | 14.87 → 36.89 | 22.0 | 0.00 | 0A/7F | 15.43 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 36.89 | 0A/7F | 0 | 15.43 m | 12/09 02:26 |
| Barragem Sul Ituporanga | 7.72 | 0A/5F | 0 | 15.5 m | 12/09 02:27 |
...
- nível atual: SDC 6.02 m · DC-RS 5.85 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.13 m
