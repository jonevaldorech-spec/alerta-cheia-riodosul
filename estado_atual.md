# Cheia — Rio do Sul (SC) — 2026-09-16 06:00 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 4.7 m — **ATENÇÃO** · tendência estável/caindo
- SDC-00013: 4.85 m · DC-RS Dom Tito: 4.7 m · offset medido DC-RS−SDC: -0.15 m
**Chuva 24h máx (drivers):** 0.6 mm
**EVENTO ATIVO:** 🔴 SIM

**🎯 MODO CRISTA (nowcast — chuva encerrada, réguas-líder viradas):** pico ~4.71 m → **ATENÇÃO** · crista já atingida/passando
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.069 m/h (anterior -0.04 m/h) · chuva-driver 2h 0.1 mm/h
...
- baseline = VALE do ato: 4.7 m em 16/09 05:55 (DC-RS) · subida até agora 0.0 m
...
|---|---|---|---|---|---|---|
| Oeste | 48.85 → 48.56 | 0.0 | 1.00 | 7A/0F | 17.08 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 48.56 | 7A/0F | 0 | 17.08 m | 16/09 05:52 |
| Barragem Sul Ituporanga | 1.01 | 5A/0F | 0 | 10.3 m | 16/09 05:52 |
...
- **A) SDC-00013:** baseline 4.86 m · pico v1.0 ~4.9 m (banda 4.4–5.4) → **Atenção**
- **B) DC-RS Dom Tito:** baseline 4.7 m · pico v1.0 ~4.7 m (banda 4.2–5.2) → **Atenção**
- **Δ pico (B − A): -0.20 m** · classe inalterada
- nível atual: SDC 4.85 m · DC-RS 4.7 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 3.82 m
