# Cheia — Rio do Sul (SC) — 2026-09-15 09:30 (local −03)
...
**🎯 MODO CRISTA (nowcast — chuva encerrada, réguas-líder viradas):** pico ~5.05 m → **ATENÇÃO** · crista já atingida/passando
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.008 m/h (anterior 0.0 m/h) · chuva-driver 2h 0.1 mm/h
...
- baseline = VALE do ato: 5.04 m em 15/09 09:06 (DC-RS) · subida até agora 0.01 m
...
|---|---|---|---|---|---|---|
| Oeste | 57.64 → 57.48 | 0.0 | 1.00 | 7A/0F | 18.27 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 57.48 | 7A/0F | 0 | 18.27 m | 15/09 09:22 |
| Barragem Sul Ituporanga | 7.72 | 5A/0F | 0 | 15.5 m | 15/09 09:22 |
...
- nível atual: SDC 5.22 m · DC-RS 5.05 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.14 m
