# Cheia — Rio do Sul (SC) — 2026-09-13 15:30 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 5.44 m — **ATENÇÃO** · tendência estável/caindo
- SDC-00013: 5.58 m · DC-RS Dom Tito: 5.44 m · offset medido DC-RS−SDC: -0.14 m
**Chuva 24h máx (drivers):** 2.4 mm
**EVENTO ATIVO:** 🔴 SIM

**Pico estimado (v1.0, OFICIAL):** ~5.4 m (banda p10–p90 5.0–5.9 m) → **Atenção**
**Classe que dispara o alerta/e-mail: Atenção**
- baseline = VALE do ato: 5.44 m em 13/09 15:11 (DC-RS) · subida até agora 0.0 m
...
- cj efetiva 0 mm = cj 0 + trânsito-acima 0 (fração de comportas aberta 0.20) + pluviômetro-ΔV 0 (ΔV do ato 0.1 hm³)
- sombra (cj_lat, c/ laterais): ~5.4 m (cj 0 mm · Δcj_lat−cj_v07 = 0.0 mm, n_laterais=4)
- modelo antigo v0.9 (conservador, sem crédito de retenção, chuva do ato): ~5.6 m → Alerta (só comparação)

### Barragens no ato (desde o vale)

| Barragem | % no vale → agora | ΔV retido (hm³) | Fração aberta (média) | Comportas | Montante | Obs |
|---|---|---|---|---|---|---|
| Oeste | 65.02 → 65.1 | 0.1 | 0.00 | 2A/5F | 19.24 m |  |
| Sul | 20.55 → 20.47 | 0.0 | 0.41 | 4A/1F | 19.46 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 65.1 | 2A/5F | 0 | 19.24 m | 13/09 15:26 |
| Barragem Sul Ituporanga | 20.47 | 4A/1F | 0 | 19.46 m | 13/09 15:26 |
...
- **A) SDC-00013:** baseline 5.6 m · pico v1.0 ~5.6 m (banda 5.1–6.1) → **Alerta**
- **B) DC-RS Dom Tito:** baseline 5.44 m · pico v1.0 ~5.4 m (banda 5.0–5.9) → **Atenção**
- **Δ pico (B − A): -0.20 m** · ⚠ MUDA A CLASSE: Alerta → Atenção
- nível atual: SDC 5.58 m · DC-RS 5.44 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 4.64 m
