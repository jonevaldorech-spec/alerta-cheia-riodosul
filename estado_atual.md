# Cheia — Rio do Sul (SC) — 2026-09-13 07:30 (local −03)
...
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.01 m/h (anterior -0.01 m/h) · chuva-driver 2h 0.2 mm/h
...
- baseline = VALE do ato: 5.47 m em 12/09 18:19 (DC-RS) · subida até agora 0.15 m
- chuva-jusante do ato: 0.5 mm (drivers (divergiu +18% das ancoras); soma horária desde o vale (13 h, cobertura 99%)) · chuva-acima 1.7 mm
- cj efetiva 6 mm = cj 0 + trânsito-acima 0 (fração de comportas aberta 0.20) + pluviômetro-ΔV 5 (ΔV do ato 6.9 hm³)
...
|---|---|---|---|---|---|---|
| Oeste | 55.44 → 62.32 | 6.9 | 0.00 | 0A/7F | 18.89 m |  |
| Sul | 21.37 → 21.04 | 0.0 | 0.40 | 2A/3F | 19.61 m |  |

## Chuva-jusante fundida DO ATO — soma horária desde o vale (13 h, cobertura 99%)
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 62.32 | 0A/7F | 0 | 18.89 m | 13/09 07:26 |
| Barragem Sul Ituporanga | 21.04 | 2A/3F | 0 | 19.61 m | 13/09 07:26 |
...
- nível atual: SDC 5.79 m · DC-RS 5.62 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 4.76 m
