# Cheia — Rio do Sul (SC) — 2026-09-13 04:30 (local −03)
...
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual 0.0 m/h (anterior 0.003 m/h) · chuva-driver 2h 1.0 mm/h
...
- chuva-jusante do ato: 0.5 mm (drivers (divergiu +30% das ancoras); soma horária desde o vale (11 h, cobertura 100%)) · chuva-acima 1.5 mm
- cj efetiva 5 mm = cj 0 + trânsito-acima 0 (fração de comportas aberta 0.20) + pluviômetro-ΔV 4 (ΔV do ato 5.7 hm³)
- sombra (cj_lat, c/ laterais): ~5.6 m (cj 0 mm · Δcj_lat−cj_v07 = -0.2 mm, n_laterais=4)
...
|---|---|---|---|---|---|---|
| Oeste | 55.44 → 61.12 | 5.7 | 0.00 | 0A/7F | 18.74 m |  |
| Sul | 21.37 → 21.13 | 0.0 | 0.40 | 2A/3F | 19.64 m |  |

## Chuva-jusante fundida DO ATO — soma horária desde o vale (11 h, cobertura 100%)
...
_Chuva-acima (contexto de barragem, fora do cj):_ Taio_montante 4.0, Rio do Campo 0.6, Alfredo Wagner 0.0

## Barragens (Asthon)

| Barragem | % uso | Comportas | Vertido | Montante | Medida em |
|---|---|---|---|---|---|
| Barragem Oeste Taió | 61.12 | 0A/7F | 0 | 18.74 m | 13/09 04:26 |
| Barragem Sul Ituporanga | 21.13 | 2A/3F | 0 | 19.64 m | 13/09 04:26 |
