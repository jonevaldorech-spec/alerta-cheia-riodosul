# Cheia — Rio do Sul (SC) — 2026-09-14 16:30 (local −03)
...
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual -0.007 m/h (anterior -0.011 m/h) · chuva-driver 2h 0.1 mm/h
...
|---|---|---|---|---|---|---|
| Oeste | 64.86 → 64.31 | 0.0 | 0.71 | 5A/2F | 19.14 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 64.31 | 5A/2F | 0 | 19.14 m | 14/09 16:27 |
| Barragem Sul Ituporanga | 16.6 | 5A/0F | 0 | 18.5 m | 14/09 16:27 |
