# Cheia — Rio do Sul (SC) — 2026-09-12 21:30 (local −03)

**Rio do Sul (DC-RS (Asthon Ponte Dom Tito)):** 5.57 m — **ALERTA** · tendência subindo
- SDC-00013: 5.73 m · DC-RS Dom Tito: 5.57 m · offset medido DC-RS−SDC: -0.16 m
**Chuva 24h máx (drivers):** 1.0 mm
**EVENTO ATIVO:** 🔴 SIM

**Pico estimado (v1.0, OFICIAL):** ~5.5 m (banda p10–p90 5.0–6.0 m) → **Alerta**
**Classe que dispara o alerta/e-mail: Alerta**
- baseline = VALE do ato: 5.47 m em 12/09 18:19 (DC-RS) · subida até agora 0.1 m
- chuva-jusante do ato: 0.1 mm (drivers (divergiu -67% das ancoras); soma horária desde o vale (4 h, cobertura 100%)) · chuva-acima 0.0 mm
- cj efetiva 2 mm = cj 0 + trânsito-acima 0 (fração de comportas aberta 0.20) + pluviômetro-ΔV 1 (ΔV do ato 2.0 hm³)
...
|---|---|---|---|---|---|---|
| Oeste | 55.44 → 57.41 | 2.0 | 0.00 | 0A/7F | 18.26 m |  |
| Sul | 21.37 → 21.37 | 0.0 | 0.40 | 2A/3F | 19.71 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 57.41 | 0A/7F | 0 | 18.26 m | 12/09 20:56 |
| Barragem Sul Ituporanga | 21.37 | 2A/3F | 0 | 19.71 m | 12/09 20:56 |
...
- **B) DC-RS Dom Tito:** baseline 5.47 m · pico v1.0 ~5.5 m (banda 5.0–6.0) → **Alerta**
- **Δ pico (B − A): -0.20 m** · classe inalterada
- nível atual: SDC 5.73 m · DC-RS 5.57 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 4.75 m
