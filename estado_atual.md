# Cheia — Rio do Sul (SC) — 2026-09-10 17:00 (local −03)
...
- método: projeção da trajetória (decaimento linear da taxa, validado −0,03/+0,02 nos ev.15/16). Taxa atual 0.02 m/h (anterior 0.048 m/h) · chuva-driver 2h 0.8 mm/h
...
- cj efetiva 53 mm = cj 39 + trânsito-acima 14 (fração de comportas aberta 0.89) + pluviômetro-ΔV 0 (ΔV do ato 0.0 hm³)
...
|---|---|---|---|---|---|---|
| Oeste | 41.84 → 9.1 | 0.0 | 1.00 | 0A/7F | 10.43 m |  |
| Sul | 0.0 → 0.0 | 0.0 | 0.78 | 0A/5F | 7.0 m |  |
...
|---|---|---|---|---|
| Barragem Oeste Taió | 9.1 | 0A/7F | 0 | 10.43 m |
...
- nível atual: SDC 4.42 m · DC-RS 4.28 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 3.98 m
