# Cheia — Rio do Sul (SC) — 2026-09-12 23:00 (local −03)
...
- chuva-jusante do ato: 0.2 mm (drivers (divergiu -47% das ancoras); soma horária desde o vale (6 h, cobertura 100%)) · chuva-acima 0.0 mm
- cj efetiva 2 mm = cj 0 + trânsito-acima 0 (fração de comportas aberta 0.20) + pluviômetro-ΔV 2 (ΔV do ato 3.0 hm³)
...
|---|---|---|---|---|---|---|
| Oeste | 55.44 → 58.47 | 3.0 | 0.00 | 0A/7F | 18.4 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 58.47 | 0A/7F | 0 | 18.4 m | 12/09 22:56 |
| Barragem Sul Ituporanga | 21.37 | 2A/3F | 0 | 19.69 m | 12/09 22:56 |
...
- nível atual: SDC 5.78 m · DC-RS 5.63 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 4.81 m
