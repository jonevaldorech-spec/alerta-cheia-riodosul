# Cheia — Rio do Sul (SC) — 2026-09-14 12:30 (local −03)
...
- baseline = VALE do ato: 5.09 m em 14/09 12:26 (DC-RS) · subida até agora 0.0 m
...
|---|---|---|---|---|---|---|
| Oeste | 65.5 → 65.34 | 0.0 | 0.71 | 5A/2F | 19.27 m |  |
...
|---|---|---|---|---|---|
| Barragem Oeste Taió | 65.34 | 5A/2F | 0 | 19.27 m | 14/09 12:27 |
| Barragem Sul Ituporanga | 17.35 | 5A/0F | 0 | 18.7 m | 14/09 12:27 |
...
- **A) SDC-00013:** baseline 5.25 m · pico v1.0 ~5.3 m (banda 4.8–5.8) → **Atenção**
- **B) DC-RS Dom Tito:** baseline 5.09 m · pico v1.0 ~5.1 m (banda 4.6–5.6) → **Atenção**
- **Δ pico (B − A): -0.20 m** · classe inalterada
- nível atual: SDC 5.25 m · DC-RS 5.09 m · Kanitz (checagem, offset→Dom Tito NÃO CALIBRADO): 5.1 m
